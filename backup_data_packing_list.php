	...
	if(in_array($file_ext, $allowed_ext))
	{
		...
		foreach ($data as $x => $val) 
		{
			if($x != 0){
				...
				if($idDetail != ""){
					$packingQuery = "INSERT INTO tb_packing_list (ctn_no, no_ctn, prs_ctn, qty_prs, id_add_packing, id_detail) 
                            	VALUES ('$ctn_no','$no_ctn','$prs_ctn','$qty_prs','$idPacking','$idDetail')";
