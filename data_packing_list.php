...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 style="font-size : 18px;" class="m-0 font-weight-bold text-dark"><center>Data Packing List </center></h6>
        </div>
        <div style="font-size : 11px;" class="card-body">
            <div class="table-responsive">
                <?php
                    ...
                    if($b == 0){ ?>
                        <form action="import_packing_list.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="input-group input-group-sm mb-3">
                                <input name="import_packing_list" type="file" class="form-control" id="inputGroupfile02" required>&emsp;
                                <button type="submit" name="excel_packing_list" style="font-size: 12px;" class="btn btn-primary btn-sm" for="inputGroup02">Upload</button>
                            </div>
                        </form>
                    <?php }
                ?>
                ...
                <table class="display table table-bordered table-striped" id="" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php foreach ($allSize as $dataSize) { ?>
                                <?php if ($dataSize['size']==$data['size']){
                                    $packingMetode = $data['packing_metode'];
                                }else{
                                    $packingMetode = "";
                                } ?>
                                <td style="text-align: center;"><?= $packingMetode ?></td>
                            <?php } ?>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th style="text-align: center;"><?php foreach (qty() as $key) { echo $key[0]; }?></th>
                            <th style="text-align: center;"><?php foreach (totalcarton() as $key) { echo $key[0]; }?></th>
                ...
                <?php
                    ...
                    if($b == 0){
                        ...
                        <a href="<?= 'functions/function_packing_list.php?delete='.$_GET['id_add_packing']; ?>" onclick="return confirm('Are you sure ?')" class="btn btn-danger btn-sm"><i>Delete All</i></a>
                        <?php 
                        $a = $_GET['id_add_packing'];
