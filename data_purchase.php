    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 style="font-size : 18px;" class="m-0 font-weight-bold text-dark"><center>Data Purchase Order</center></h6>
            </div>
            <div class="card-body">
		         ...
		         [
		         	{
		         		"targets": -1,
		             	"data": null,
		             	"defaultContent": "<center><button class='btn btn-info btn-sm tblKelola'><i class='fas fa-hand-pointer'></i></button></center>" 
		         	}
		        ]
		    });
        $('#invoice tbody').on( 'click', '.tblKelola', function () {
		    var data = table.row( $(this).parents('tr')).data();
		    window.location.href = "kelola_purchase.php?id_invoice="+ data[3];
		});
    });
</script>
