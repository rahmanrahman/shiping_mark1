...
<table border="1">
	...
	<tr>
        ...
        <td rowspan="2" style="vertical-align: middle; text-align: center;"><?= $data['color'];?></td>
        <td rowspan="2" style="vertical-align: middle; text-align: center;"><?= $data['widht'];?></td>
        <td rowspan="2" style="vertical-align: middle; text-align: center;"><?= $data['carton_code'];?></td>
        <td rowspan="2" style="vertical-align: middle; text-align: center;"><?= $data['meas'];?></td>
