                ...
                <form action="functions/function_booking.php" method="POST" enctype="multipart/form-data">
                    <div>
                        <div class="input-group input-group-sm mb-3">
                            <input type="hidden" name="id_booking" class="input" value="<?php echo $_GET['id_booking'] ?>">
            ...
            <div class="card-body">
                ...
                <div class="row row-cols-1 row-cols-md-3 g-4">
                    ...
                    <div class="col">
                        <div style="font-size:14px;" class="card-body-footer">
                            <div class="mb-3 row">
                                <label style="font-weight : bolder;" for="staticEmail" class="col-sm-3 col-form-label">Ship To :</label>
                                <div class="col-sm-9">
                                    <b><?php echo $data['shipto_booking'] ?></b>
                                </div>
                                <label style="font-weight : bolder;" for="staticEmail" class="col-sm-3 col-form-label">Address</label>
                                <div class="col-sm-9">
                                    <?php echo nl2br($data['address_booking']); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div style="font-size:14px;" class="card-body-footer">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <?php echo nl2br($data['notify_booking']); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="table table-bordered" id="" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;"><a href="<?='functions/function_booking.php?hapusPacking='.$data['id_detail_booking'];?>&id_booking=<?php echo $id_booking;?>" onclick="return confirm('Are you sure ?')" class="btn btn-danger btn-circle btn-sm"><i class="fas fa-trash"></i></a></td>
                            </tr>
                        ...
                        <a href="excel_booking.php?id_booking=<?php echo $id_booking;?>" type="button" class="btn btn-success btn-sm">EXCEL</a>
                        <a href="print_booking.php?id_booking=<?php echo $_GET['id_booking']; ?>" type="button" target="_BLANK" class="btn btn-info btn-sm">PRINT</a>
                </div>
            </div>
        </div>
    </div>
