                ...
                <table class="display table table-bordered table-striped" id="" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php
                            if (isset($_GET['id_summary'])) {
                                ...
                                $subtotalnw = $subtotalgw = $subtotalcbm = 0;
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><?php echo number_format($totalnw,2,".",",") ?></td>
                            <td style="text-align: center;"><?php echo number_format($totalgw,2,".",",") ?></td>
                            <td style="text-align: center;"><?php echo number_format($totalcbm,2,".",",") ?></td>
                        </tr>
                    </tbody>
                    <?php
                        }
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th style="text-align: center;"></th>
                            <th style="text-align: center;"><?php echo number_format($subtotalnw,2,".",",")?></th>
                            <th style="text-align: center;"><?php echo number_format($subtotalgw,2,".",",")?></th>
                            <th style="text-align: center;"><?php echo number_format($subtotalcbm,2,".",",") ?></th>
                        </tr>
                    </tfoot>
                </table>
                <a href="excel_packing_list.php?id_summary=<?php echo $_GET['id_summary']; ?>" type="button" class="btn btn-success btn-sm">EXCEL</a>
                <a href="print_packing_list.php?id_summary=<?php echo $_GET['id_summary']; ?>" type="button" target="_BLANK" class="btn btn-info btn-sm">CETAK</a>
            </div>
        </div>
    </div>
</div>
