                ...
                <table class="display table table-bordered table-striped" id="" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><?= $nilaicbm ?></td>
                        </tr>
                    </tbody>
                    <?php
                        }
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th style="text-align: center;"><?= $totalcarton ?></th>
                            <th style="text-align: center;"></th>
                            ...
                            <th style="text-align: center;"><?= $nilaicbm ?></th>
                        </tr>
                    </tfoot>
                </table>
                <a href="excel_packing_prepack.php?id_summary=<?= $_GET['id_summary']; ?>" type="button" class="btn btn-success btn-sm">EXCEL</a>
                <a href="print_packing_prepack.php?id_summary=<?= $_GET['id_summary']; ?>" type="button" target="_BLANK" class="btn btn-info btn-sm">CETAK</a>
            </div>
        </div>
    </div>
</div>
