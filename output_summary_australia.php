        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <?php 
                    ...
                    <?php }else{
                        ?>
                        <a href="excel_shipping_australia.php?id_summary=<?php echo $_GET['id_summary']; ?>&po=<?php echo $value;?>" type="button" class="btn btn-success btn-sm">EXCEL</a>
                        <a href="print_shipping_australia.php?id_summary=<?php echo $_GET['id_summary']; ?>&po=<?php echo $value;?>" type="button" target="_BLANK" class="btn btn-info btn-sm">PRINT SUMMARY</a>
                    <?php }
                ?>
                <br><br>
                    <a href="print_prepack_australiaA4.php?id_summary=<?php echo $_GET['id_summary'];?>&po=<?php echo $value;?>" target="_BLANK" type="button" class="btn btn-dark btn-sm">PRINT SHIPPING MARK A4</a>
                    <a href="print_prepack_australiaA5.php?id_summary=<?php echo $_GET['id_summary'];?>&po=<?php echo $value;?>" target="_BLANK" type="button" class="btn btn-danger btn-sm">PRINT SHIPPING MARK A5</a>
            </div>
        </div>
    </div>
</div>
