        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <?php 
                    ...
                    <?php }else{
                        ?>
                        <a href="excel_summary_usa.php?id_summary=<?php echo $_GET['id_summary']; ?>&po=<?php echo $value;?>" type="button" class="btn btn-success btn-sm">EXCEL</a>
                        <a href="print_summary_usa.php?id_summary=<?php echo $_GET['id_summary']; ?>&po=<?php echo $value;?>" type="button" target="_BLANK" class="btn btn-info btn-sm">PRINT SUMMARY</a>
                    <?php }
                ?>
                <br><br>                
                <?php 
