            ...
            <div>
                ...
                <div class="">
                            ...
                            <div class="col">
                                <div style="font-size:14px;" class="card-body-footer">
                                    <div class="mb-3 row">
                                        ...
                                        <label style="font-weight : bolder;" for="staticEmail" class="col-sm-2 col-form-label">Notify :</label>
                                        <div class="col-sm-10">
                    ...
                    <div class="card-body">
                            ...
                            <table style="font-size : 12px;" width="100%" cellspacing="0">
                                <thead class="table table-bordered1">
                                    <tr style="border: 1px black;">
                                        ...
                                        <th width="100px" style="text-align: center; vertical-align: middle;">PO REFERANCE</th>
                                        <th style="text-align: center; vertical-align: middle;">HS CODE</th>
                                        <th width="100px" style="text-align: center; vertical-align: middle;">SIZE</th>
                                        ...
                                        <th width="80px" style="text-align: center; vertical-align: middle;">Unit Price (FOB)</th>
                                        <th width="80px" style="text-align: center; vertical-align: middle;">TOTAL VALUE (USD)</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        ?>
                                        <td width="80px" style="text-align: center;"><?php echo $totalQty ?></td>
                        ...
                        <div style="font-size: 12px; font-weight: bold;">SAY TOTAL UNITED STATES DOLLARS  : </div>
                        <br><br><br>
