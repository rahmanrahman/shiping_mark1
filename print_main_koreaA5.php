...
<body style="font-family: Arial, Helvetica, sans-serif;">
    ...
    <?php for ($i = 0; $i < $total; $i++){?>
        <table style="font-size:42px; font-weight:bolder; line-height: 74px;">
            <tr>
                <td style="font-size:50px;" colspan="15">NEW BALANCE</td>
            ...
            <tr>
                <td>SIZE</td>
                <td>:</td>
                <td width="70px"><?= $data['size']+0;?></td>
                <td colspan="2">AND KOREA</td> 
                <td width="20px">:</td>
                <td><?php 
                        if($data["gender"] == "Men"){
