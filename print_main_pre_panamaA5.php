...
<body style="font-family: Arial, Helvetica, sans-serif;">
    ...
    <?php for ($i = 0; $i < $total; $i++){?>
        <table style="font-size:38px; font-weight:bolder; line-height: 50px;">
            <tr >
            ...
            <tr>
                ...
                <td style="font-size : 34px;" colspan = "1" width="300px"><center><?php echo $dataSize['size']+0;?></center></td><?php } ?>
            </tr>
            <tr>
                <td></td>
                <td></td>
