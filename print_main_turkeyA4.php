...
<body style="font-family: Arial, Helvetica, sans-serif;">
    ...
    <?php for ($i = 0; $i < $total; $i++){?>
        <table style="font-size:50px; font-weight:bolder; line-height: 68px;">
            <tr >
            ...
            <tr>
                ...
                <td style="font-size:38px;" colspan = "1" width="300px"><center><?php echo $dataSize['size']+0;?></center></td><?php } ?>
            </tr>
            <tr>
                <td></td>
                <td></td>
            ...
            <tr>
                ...
                <?php $allSize = getSize1();?>
                <?php foreach ($allSize as $dataSize) { ?>
                <td style="font-size:38px;" colspan = "1" width="300px"><center><?php if($dataSize['cust_id'] == "TURKEY"){
            ...
            <tr>
                ...
                <?php $allSize = getSize1();?>
                <?php foreach ($allSize as $dataSize) { ?>
                <td style="font-size:38px;" colspan = "1" width="300px"><center><?php echo $dataSize['packing_metode1'];?></center></td><?php } ?>
                <td style="font-size:38px;">PRS</td>
            </tr>
            <tr>
                <td>CARTON#</td>
                <td>:</td>
