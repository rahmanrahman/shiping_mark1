...
<body style="font-family: Arial, Helvetica, sans-serif;">
    ...
    <?php for ($i = 0; $i < $total; $i++){?>
        <table style="font-size:50px; font-weight:bolder; line-height: 88px;">
            <tr>
                <td width="340px">STYLE CODE</td>
                <td>:</td>
                <td colspan="15"><?php 
            ...
            <tr>
                ...
                <td style="font-size : 36px;" colspan = "1" width="70px"><center><?php echo $dataSize['size']+0;?></center></td><?php } ?>
            </tr>
            <tr>
                <td></td>
            ...
            <tr>
                ...
                <?php $allSize = getSize1();?>
                <?php foreach ($allSize as $dataSize) { ?>
                <td style="font-size : 36px;" colspan = "1" width="70px"><center><?php echo $dataSize['packing_metode1'];?></center></td><?php } ?>
            </tr>
            <tr>
                <td>CARTON NO</td>
                <td>:</td>
