...
<body style="font-family: Arial, Helvetica, sans-serif;">
    ...
    <?php for ($i = 0; $i < $total; $i++){?>
        <table style="font-size:48px; font-weight:bolder; line-height: 75px;">
            <tr>
            ...
            <tr>
                ...
                <td style="font-size : 40px;" colspan="1" width="65px"><center><?php echo $dataSize['size']+0;?></center></td><?php } ?>
            </tr>
            <tr>
                <td></td>
                <td></td>
            ...
            <tr>
                ...
                <?php $allSize = getSize1();?>
                <?php foreach ($allSize as $dataSize) { ?>
                    <td style="font-size : 40px;" colspan="1"><center><?php echo $dataSize['packing_metode1'];?></center></td><?php } ?>
            </tr>
        </table>
    <?php
        }
