                        ...
                        <div style="font-size : 12px;" >
                            <table border='1' width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <tr>
                                        <td rowspan="2" style="text-align: center;"><?= $data['factory_code'];?></td>
                                        <td rowspan="2" style="text-align: center;"><?= $data['code'];?></td>
                                        ...
                                        <td rowspan="2" style="text-align: center;"><?= $data['color'];?></td>
                                        <td rowspan="2" style="text-align: center;"><?= $data['widht'];?></td>
                                        <td rowspan="2" style="text-align: center;"><?= $data['carton_code'];?></td>
                                        <td rowspan="2" style="text-align: center;"><?= $data['meas'];?></td>
                                        ...
                                        <td colspan="1" style="vertical-align: middle; text-align: center;"><?= $dataSize['size']+0;?></td><?php } ?>
                                        <td rowspan="2" style="text-align: center;"><?= $data['ctn_no'];?></td>
                                        <td rowspan="2" style="text-align: center;"><?= $data['no_ctn'];?></td>
                                        <td rowspan="2" style="text-align: center;"><?= $data['prs_ctn'];?></td>
                                    </tr>
                                    <tr>
                                        <?php $allSize = getSize1();?>
                                        <?php foreach ($allSize as $dataSize) { ?>
                                        <td style="text-align: center;"><?= $dataSize['packing_metode1'];?></td><?php } ?>
                                    </tr>
                                </tbody>
                                <?php
                                    }
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th colspan="<?= $totalsize; ?>" style="text-align: center;">Total</th>
