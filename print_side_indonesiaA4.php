...
<body style="font-family: Arial, Helvetica, sans-serif;">
    ...
    <?php for ($i = 0; $i < $total; $i++){?>
        <table style="font-size:52px; font-weight:bolder; line-height: 74px;">
            <tr>
                <td width="350px">STYLE NO.</td>
                <td>:</td>
                <td colspan="5"><?php 
            ...
            <tr>
                <td style="vertical-align: top;" rowspan ="2">MEAS</td>
                <td style="vertical-align: top;">:</td>
                <td style="vertical-align: top; font-size: 44px;" rowspan ="2"><?php
