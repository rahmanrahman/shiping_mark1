...
<br><br><br>
    ...
    <?php for ($i = 0; $i < $total; $i++){?>
        <table style="font-size:32px; font-weight:bolder; line-height: 50px;">
            
            <tr>
                <td colspan="15" style="font-size:38px;">NBSG</td>
            </tr>
            <tr>
                <td width="240px">Ship To</td>
                <td>:&nbsp;</td>
                <td colspan="12" style="font-size:29px;"> <?= $data['destination']; ?></td>
            </tr>
            <tr>
                <td>Gross Weight</td>
                <td>:</td>
