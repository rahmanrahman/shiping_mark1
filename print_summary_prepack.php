                        ...
                        <div style="font-size : 12px;" >
                            <table border='1' width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <tr>
                                        <td rowspan="3" style="text-align: center;"><?php echo $data['factory_code'];?></td>
                                        <td rowspan="3" style="text-align: center;"><?php echo $po;?></td>
                                        <td rowspan="3" style="text-align: center;"><?php 
                                        ...
                                        <td rowspan="3" style="text-align: center;"><?php echo $data['color'];?></td>
                                        <td rowspan="3" style="text-align: center;"><?php echo $data['widht'];?></td>
                                        <td rowspan="3" style="text-align: center;"><?php echo $data['carton_code'];?></td>
                                        <td rowspan="3" style="text-align: center;"><?php echo $data['meas'];?></td>
                                        <td rowspan="3" style="text-align: center;"><?php foreach (subtotalNW() as $key) { echo $key[0]; }?></td>
                                        <td rowspan="3" style="text-align: center;"><?php foreach (subtotalGW() as $key) { echo $key[0]; }?></td>
                                        ...
                                        <td rowspan="3" style="text-align: center;"><?php echo $data['ctn_no'];?></td>
                                        <td rowspan="3" style="text-align: center;"><?php echo $data['no_ctn'];?></td>
                                        <td rowspan="3" style="text-align: center;"><?php echo $data['prs_ctn'];?></td>
                                    </tr>
                                    <tr>
                                        <?php $allSize = getSize1();?>
                                        <?php foreach ($allSize as $dataSize) { ?>
